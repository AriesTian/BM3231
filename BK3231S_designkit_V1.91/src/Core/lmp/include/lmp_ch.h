 ...
 * DATE:            17-06-99        
 * SOURCE CONTROL:  $Id: lmp_ch.h,v 1.71 2010/02/11 02:02:56 garyf Exp $
 *
 * LICENSE:
...
void LMconnection_LMP_Switch_Accepted_Ack(t_deviceIndex device_index);
t_error  LMconnection_LM_Page_Complete(t_LC_Event_Info* eventInfo);
...
void LMconnection_LM_EventInd(int eventCode, t_lm_callback functPtr);
