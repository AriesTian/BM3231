 ...
 * DATE:           22-12-1999
 *
 * SOURCE CONTROL: $Id: lmp_features.h,v 1.17 2009/06/03 15:41:42 morrisc Exp $
 *
 * LICENSE:
...
#define ABSENCE_MASK                   0x04 /* note: still officially reserved in BT2.1+EDR */
#define AFH_CAPABLE_SLAVE_MASK         0x08
#define AFH_CLASSIFICATION_SLAVE_MASK  0x10
#define ALIAS_AUTHENTICATION_MASK      0x20 /* note: still officially reserved in BT2.1+EDR */
#define ANONYMITY_MODE_MASK            0x40 /* note: still officially reserved in BT2.1+EDR */
...
#define mFeat_Check_Absence_Masks(features)             ( features[4] & ABSENCE_MASKS_MASK  )
