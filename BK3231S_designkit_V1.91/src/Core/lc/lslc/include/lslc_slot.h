...
void FAST_CALL LSLCslot_Handle_PKA(void);
void FAST_CALL LSLCslot_Handle_PKD(void);
void FAST_CALL LSLCslot_Handle_NO_PKT_RCVD(void);
void FAST_CALL LSLCslot_Handle_PKD_RX_HDR(void);
void FAST_CALL LSLCslot_Handle_TIM0(void);
void FAST_CALL LSLCslot_Handle_TIM1(void);
void FAST_CALL LSLCslot_Handle_TIM2(void);
void FAST_CALL LSLCslot_Handle_TIM3(void);
void FAST_CALL LSLCslot_Handle_SYNC_DET(void);
void  LSLCslot_Handle_AUX_TIM(void);

boolean FAST_CALL LSLCslot_Local_Piconet_Request(void);
