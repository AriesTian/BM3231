...
enum 
{
    ...
    HCI_SPREADTRUM_Q   = SCO_OUT_Q + PRH_BS_CFG_SYS_MAX_SYN_LINKS_VIA_HCI,

    TRA_QUEUE_TOTAL_NUM_QUEUES = HCI_SPREADTRUM_Q + 1
#else
    //HCI_SPREADTRUM_Q   = L2CAP_OUT_Q + MAX_ACTIVE_DEVICE_LINKS+1,
 ...
 ****************************************************************************/
boolean FAST_CALL BTq_Is_Queue_Empty(u_int8 q_type, t_deviceIndex device_index);
 ...
 ****************************************************************************/
t_q_descr FAST_CALL *BTq_Enqueue(u_int8 q_type, t_deviceIndex device_index, t_length);
 ...
 ****************************************************************************/
void FAST_CALL BTq_Commit(u_int8 q_type, t_deviceIndex device_index);
 ...
 ****************************************************************************/
t_q_descr FAST_CALL *BTq_Dequeue_Next(u_int8 q_type, t_deviceIndex device_index);
 ...
 ****************************************************************************/
t_q_descr FAST_CALL *BTq_BB_Dequeue_Next(
 ...
 *
 ****************************************************************************/
t_q_descr FAST_CALL *BTq_Dequeue_Next_Data_By_Length(
 ...
 ****************************************************************************/
void FAST_CALL BTq_Ack_Last_Dequeued(
...
u_int16 FAST_CALL BTq_BB_Dequeue_Next_Synchronous(u_int8 q_type, u_int8 sco_index, 
                                   u_int16 packet_length, u_int8 *buffer);

u_int16 FAST_CALL BTq_Get_Total_Bytes_Enqueued(u_int8 q_type, t_deviceIndex device_index);
