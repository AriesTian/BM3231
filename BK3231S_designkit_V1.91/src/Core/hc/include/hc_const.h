 ...
 *
 * SOURCE CONTROL: $Id: hc_const.h,v 1.79 2010/04/29 10:43:47 garyf Exp $
 *    
 **********************************************************************/
...
#define VENDOR_SPECIFIC_DEBUG_MTK_OGF_39   0x39
#define VENDOR_SPECIFIC_DEBUG_MTK_OGF_1f   0x1f
#define VENDOR_SPECIFIC_DEBUG_MTK_OGF_23   0x23
#endif
...
#ifdef SUPPORT_MTK_SPECAIL_COMMAND//support MTK command
#define HCI_LINK_POLICY_MTK_cmd_91                           (0x0091 + LP_G)
#define HCI_LINK_POLICY_MTK_cmd_97                           (0x0097 + LP_G)
#define HCI_LINK_POLICY_MTK_cmd_93                           (0x0093 + LP_G)
#define HCI_LINK_POLICY_MTK_cmd_9b                           (0x009b + LP_G)
#endif
...
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_a1              (0x00a1 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_a3              (0x00a3 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_8a              (0x008a + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_85              (0x0085 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_81              (0x0081 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_93              (0x0093 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_c0              (0x00c0 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_b6              (0x00b6 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_88              (0x0088 + HS_G)


#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_d7              (0x00d7 + HS_G)
#define HCI_MTK_LOCAL_STATUS_SPECAIL_CMD_c4              (0x00c4 + HS_G)
...
#define HCI_SPREADTRUM_SPECAIL_EVENT                         0xfe
