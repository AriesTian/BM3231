#line 1 "src\\Driver\\driver_WDT.c"
...
#line 10 "src\\Driver\\driver_WDT.c"

void Driver_wdt_enable(uint16 wdt_cnt)


{
    (*((volatile unsigned long *) (0x00800000 + 0x1c) )) = 0x0 ; 
	(*((volatile unsigned long *) 0x00F00000))  = wdt_cnt;   
	
	 
	 (*((volatile unsigned long *) 0x00F00000)) = (0x5A<<16) + wdt_cnt;
	 (*((volatile unsigned long *) 0x00F00000)) = (0xA5<<16) + wdt_cnt;
}
...
void Driver_wdt_disable(void)
{
	...
	(*((volatile unsigned long *) 0x00F00000)) = 0x005A0000;
    (*((volatile unsigned long *) 0x00F00000)) = 0x00A50000;
}
