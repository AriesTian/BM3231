#line 1 "src\\App\\DeviceBtj_Stack_Sdpdb.c"
...
#line 2 "src\\App\\DeviceBtj_Stack_Sdpdb.c"
...
SDP_DB_ATTRIBUTE_T pnp_record[] =
{
    ...
    {0x0200, (BTPBYTE)"\x09\x01\x00", 0x03},
    {0x0201, (BTPBYTE)"\x09\x04\xe8", 0x03},
    {0x0202, (BTPBYTE)"\x09\x70\x21", 0x03},
    {0x0203, (BTPBYTE)"\x09\x00\x01", 0x03},
    {0x0204, (BTPBYTE)"\x28\x01", 0x02},
    {0x0205, (BTPBYTE)"\x09\x00\x02", 0x03},
    ...
    if (adapter != (0x00) && service != (0x00))
    {
        ...
        if (sdp_db != (0x00))
        {
            ...
            case DEVICEBTJ_OBJECT_SPP:
            {
                ...
                sdp_db->index   = 0x00;
                sdp_db->channel = 0x01;
                sdp_db->handle  = (0x00010000) + sdp_db->channel;
