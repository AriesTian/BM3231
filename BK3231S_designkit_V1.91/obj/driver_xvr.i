#line 1 "src\\Driver\\driver_xvr.c"
...
#line 2 "src\\Driver\\driver_xvr.c"

volatile uint32 *p_APB_XVER_ADDR   = (volatile uint32*)  0x00F10000 ;
...
void kmod_calibration(void) 
{
	...
	(*((volatile uint32 *)(0x00F10000+0x04))) = XVR_ANALOG_REG_BAK[1]  = 0x65F9364C;
	
	(*((volatile uint32 *)(0x00F10000+0x94))) |= (1<<12);
	delay_ms(1);
	(*((volatile uint32 *)(0x00F10000+0x94))) |= (1<<13);
	
	delay_ms(1);
	
	(*((volatile uint32 *)(0x00F10000+0x94))) |= (1<<16);
	delay_ms(50);
	value = (*((volatile uint32 *)(0x00F10000+0x48)));
	...
	(*((volatile uint32 *)(0x00F10000+0xC0))) &= (~(0x1ff<<21));
	(*((volatile uint32 *)(0x00F10000+0xC0))) |= (value_kcal_result<<21);
		
	(*((volatile uint32 *)(0x00F10000+0x94))) &= (~(1<<16));
	(*((volatile uint32 *)(0x00F10000+0x04))) = XVR_ANALOG_REG_BAK[1]  = 0x65F936CC;
...
void xver_initial(void)
{
    ...
    (*((volatile uint32 *)(0x00F10000+0x00))) = XVR_ANALOG_REG_BAK[0]  = 0x041025FB;
    (*((volatile uint32 *)(0x00F10000+0x04))) = XVR_ANALOG_REG_BAK[1]  = 0x65F936CC;
    (*((volatile uint32 *)(0x00F10000+0x08))) = XVR_ANALOG_REG_BAK[2]  = 0x41083441;
    (*((volatile uint32 *)(0x00F10000+0x0C))) = XVR_ANALOG_REG_BAK[3]  = 0x809FEC00;
    (*((volatile uint32 *)(0x00F10000+0x10))) = XVR_ANALOG_REG_BAK[4]  = 0x7F91FE90;
    (*((volatile uint32 *)(0x00F10000+0x14))) = XVR_ANALOG_REG_BAK[5]  = 0x05490A0B;
    (*((volatile uint32 *)(0x00F10000+0x18))) = XVR_ANALOG_REG_BAK[6]  = 0x3D2B120f;
    (*((volatile uint32 *)(0x00F10000+0x1C))) = XVR_ANALOG_REG_BAK[7]  = 0xc000480E;
    (*((volatile uint32 *)(0x00F10000+0x20))) = XVR_ANALOG_REG_BAK[8]  = 0x07A4A028;
    
    (*((volatile uint32 *)(0x00F10000+0x24))) = XVR_ANALOG_REG_BAK[9]  = 0x19407D00;



    (*((volatile uint32 *)(0x00F10000+0x28))) = XVR_ANALOG_REG_BAK[10] = 0xc0036208;

    (*((volatile uint32 *)(0x00F10000+0x2C))) = XVR_ANALOG_REG_BAK[11] = 0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x30))) = XVR_ANALOG_REG_BAK[12] = 0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x34))) = XVR_ANALOG_REG_BAK[13] = 0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x38))) = XVR_ANALOG_REG_BAK[14] = 0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x3C))) = XVR_ANALOG_REG_BAK[15] = 0x00000000;
    
    
    (*((volatile uint32 *)(0x00F10000+0x40)))=0x00103232;
    (*((volatile uint32 *)(0x00F10000+0x44)))=0x15311910;
    (*((volatile uint32 *)(0x00F10000+0x48)))=0x00000056;
    (*((volatile uint32 *)(0x00F10000+0x4C)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x50)))=0x00080000;
    (*((volatile uint32 *)(0x00F10000+0x54)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x58)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x5C)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x60)))=0x000001DE;
    (*((volatile uint32 *)(0x00F10000+0x64)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x68)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x6C)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x70)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x74)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x78)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x7C)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0x80)))=0x00A57977;
    (*((volatile uint32 *)(0x00F10000+0x84)))=0x0295E500;
    (*((volatile uint32 *)(0x00F10000+0x88)))=0x96000011;
    (*((volatile uint32 *)(0x00F10000+0x8C)))=0xA0000000;
    (*((volatile uint32 *)(0x00F10000+0x90)))=0x00000400;
    (*((volatile uint32 *)(0x00F10000+0x94)))=0x02300000;
    (*((volatile uint32 *)(0x00F10000+0x98)))=0x58000800;
    (*((volatile uint32 *)(0x00F10000+0x9C)))=0x0008F100;
    (*((volatile uint32 *)(0x00F10000+0xA0)))=0x03030000;
    (*((volatile uint32 *)(0x00F10000+0xA4)))=0x00001100;
    (*((volatile uint32 *)(0x00F10000+0xA8)))=0X305a303d;
    (*((volatile uint32 *)(0x00F10000+0xAC)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xB0)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xB4)))=0x0034b041;
    (*((volatile uint32 *)(0x00F10000+0xB8)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xBC)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xC0)))=0x201000A3 ;
    (*((volatile uint32 *)(0x00F10000+0xC4)))=0x000000AA;
    (*((volatile uint32 *)(0x00F10000+0xC8)))=0xFFFF8080;
    (*((volatile uint32 *)(0x00F10000+0xCC)))=0x0000029B;
    (*((volatile uint32 *)(0x00F10000+0xD0)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xD4)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xD8)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xDC)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xE0)))=0x361C8011;
    (*((volatile uint32 *)(0x00F10000+0xE4)))=0xC0008400;
    (*((volatile uint32 *)(0x00F10000+0xE8)))=0x00000000;
    (*((volatile uint32 *)(0x00F10000+0xEC)))=0x3F541280;
    (*((volatile uint32 *)(0x00F10000+0xF0)))=0x9728051E;
    (*((volatile uint32 *)(0x00F10000+0xF4)))=0x83FD8D14;
    (*((volatile uint32 *)(0x00F10000+0xF8)))=0x83828F87;
    (*((volatile uint32 *)(0x00F10000+0xFC)))=0x0001811B;
    (*((volatile uint32 *)(0x00F10000+0x100)))=0x01000000;
    (*((volatile uint32 *)(0x00F10000+0x104)))=0x07050402;
    (*((volatile uint32 *)(0x00F10000+0x108)))=0x120F0C0A;
    (*((volatile uint32 *)(0x00F10000+0x10C)))=0x221E1A16;
    (*((volatile uint32 *)(0x00F10000+0x110)))=0x35302B26;
    (*((volatile uint32 *)(0x00F10000+0x114)))=0x4B45403A;
    (*((volatile uint32 *)(0x00F10000+0x118)))=0x635D5751;
    (*((volatile uint32 *)(0x00F10000+0x11C)))=0x7C767069;
    (*((volatile uint32 *)(0x00F10000+0x120)))=0x968F8983;
    (*((volatile uint32 *)(0x00F10000+0x124)))=0xAEA8A29C;
    (*((volatile uint32 *)(0x00F10000+0x128)))=0xC5BFBAB4;
    (*((volatile uint32 *)(0x00F10000+0x12C)))=0xD9D4CFCA;
    (*((volatile uint32 *)(0x00F10000+0x130)))=0xE9E5E1DD;
    (*((volatile uint32 *)(0x00F10000+0x134)))=0xF5F3F0ED;
    (*((volatile uint32 *)(0x00F10000+0x138)))=0xFDFBFAF8;
    (*((volatile uint32 *)(0x00F10000+0x13C)))=0xFFFFFFFE;
