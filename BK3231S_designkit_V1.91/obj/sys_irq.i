#line 1 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 21 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 22 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 23 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 24 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 25 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq.h"
...
#line 25 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq.h"
...
#line 26 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq.h"

void SYSirq_Initialise(void);

__irq void SYSirq_IRQ_Handler(void);
__irq void SYSirq_FIQ_Handler(void);
...
#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq_chimera_impl.h"
...
#line 25 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq_chimera_impl.h"
#line 26 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq_chimera_impl.h"
#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq.h"
#line 27 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq_chimera_impl.h"
...
#line 755 ".\\src\\include\\BK3231S_reg.h"
...
#line 29 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq_chimera_impl.h"
...
__inline u_int32 _SYSirq_Get_Status_IRQ(void);
...
__inline u_int32 _SYSirq_Get_Status_IRQ(void)
{
  ...
  return (*((volatile unsigned long *) (0x00800000 + 0x48) ));
}
...
__inline static void _SYSirq_Clear_IRQ(u_int32 status)
{
    ...
    (*((volatile unsigned long *) (0x00800000 + 0x48) ))=status;
...
#line 65 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_irq.h"




#line 26 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 27 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 1 ".\\src\\Core\\lc\\lslc\\include\\lslc_slot.h"
...
#line 27 ".\\src\\Core\\lc\\lslc\\include\\lslc_slot.h"

void LSLCslot_Initialise(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_PKA(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_PKD(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_NO_PKT_RCVD(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_PKD_RX_HDR(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_TIM0(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_TIM1(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_TIM2(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_TIM3(void);
void __attribute__((section("fastcall"))) LSLCslot_Handle_SYNC_DET(void);
void  LSLCslot_Handle_AUX_TIM(void);

boolean __attribute__((section("fastcall"))) LSLCslot_Local_Piconet_Request(void);
...
#line 54 ".\\src\\Core\\lc\\lslc\\include\\lslc_slot.h"
...
#line 28 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 29 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 30 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 31 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
#line 32 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 33 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 34 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 35 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 36 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
#line 67 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
__irq void __attribute__((section("fastcall"))) SYSirq_FIQ_Handler(void)
{
    unsigned int IntStat ;
    
    IntStat = (*((volatile unsigned long *) (0x00800000 + 0x48) ));
    ...
    if(IntStat & (0x01<< 0)) 
    {
        if(b_26M_colsed)
        {
            (*((volatile unsigned long *) (0x00800000 + 0x18) ))=0x00;
            (*((volatile uint32 *)(0x00F10000+0x24))) = 0x19407D00;
            Set_CPU_PLL_clk(1); 
    ...
    (*((volatile unsigned long *) (0x00800000 + 0x48) ))= IntStat;
}
...
__irq  void SYSirq_IRQ_Handler(void)
{
    ...
    if(IntStat & (0x01<< 1))           
    {
        ...
        (*((volatile unsigned long *) (0x00F00500 + 0x48) )) = 0;
        (*((volatile unsigned long *) (0x00F00500 + 0x4C) ))=0;
        (*((volatile unsigned long *) (0x00F00500 + 0x50) )) = 0xffffffff;
        (*((volatile unsigned long *) (0x00F00500 + 0x54) )) = 0xff ;
        (*((volatile unsigned long *) (0x00800000 + 0x40) )) &= ~((0x01<< 1)|(0x01<<17));
    ...
    if(IntStat & (0x01<< 6))            
    {
        ...
        sys_flag |= 0X00080000;
        (*((volatile unsigned long *) (0x00F00700 + 0x00))) |= (1<<15);
...
#line 278 "src\\hal\\prth_chimera\\sys\\sys_irq.c"

  t_SYSirq_Counters _SYSirq_Counters;

#line 374 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
void SYSirq_Disable_Interrupts_Save_Flags(u_int32 *flags)
{
    ...
    __asm
    {
	    MRS current_flags, CPSR                  
        AND my_tmp_flags, current_flags, #0xc0   
        STR my_tmp_flags, [flags]                



        ORR current_flags, current_flags, #0xc0  

        MSR CPSR_c, current_flags                  
    }
...
void SYSirq_Disable_Interrupts_Only_IRQ_Save_Flags(u_int32 *flags)
{
	...
	MRS current_flags, CPSR                  
        ...
        ORR current_flags, current_flags, #0x80  
...
void SYSirq_Enable_Interrupts_Save_Flags(u_int32 *flags)
{
    ...
    __asm
    {
        ...
        AND my_tmp_flags, current_flags, #0xc0   
        STR my_tmp_flags, [flags]                
        AND current_flags, current_flags, #0x3f  
        MSR CPSR_c, current_flags                  
    }
...
void SYSirq_Interrupts_Restore_Flags(u_int32 flags)
{
    ...
    {
        MRS current_flags, CPSR                  
        BIC current_flags, current_flags, #0xc0  
        ORR current_flags, current_flags, flags  
        MSR CPSR_c, current_flags                  
    }
...
#line 525 "src\\hal\\prth_chimera\\sys\\sys_irq.c"
...
void SYSirq_Enable_Baseband_ISR_Save_Flags(u_int32 *flags)
{
	...
	MRS current_flags, CPSR                  
        AND my_tmp_flags, current_flags, #0xC0   
        STR my_tmp_flags, [flags]                
        AND current_flags, current_flags, #0x7f  
        MSR CPSR_c, current_flags                  
    }
...
void SYSirq_Baseband_ISR_Restore_Flags(u_int32 flags)
{
    ...
    {
        MRS current_flags, CPSR                  
        BIC current_flags, current_flags, #0x80  
        ORR current_flags, current_flags, flags  
        MSR CPSR_c, current_flags                  
    }
