#line 1 "src\\Driver\\Driver_spi.c"
...
#line 10 "src\\Driver\\Driver_spi.c"
...
#line 11 "src\\Driver\\Driver_spi.c"
...
#line 1 ".\\src\\Driver\\driver_gpio.h"
#line 15 ".\\src\\Driver\\driver_gpio.h"
...
#line 12 "src\\Driver\\Driver_spi.c"
#line 13 "src\\Driver\\Driver_spi.c"
#line 14 "src\\Driver\\Driver_spi.c"



volatile char spi_tx_data[127], spi_rx_data[127];
...
__inline void spi_trans_start(void)
{
	(*((volatile unsigned long *) (0x00F00200 + 0x00) )) &= ~(0x01<<16);	 
}

__inline void spi_trans_stop(void)
{
	(*((volatile unsigned long *) (0x00F00200 + 0x00) )) |= (0x03<<16);	
}

__inline void spi_int_enable(void)
{
	do{(*((volatile unsigned long *) (0x00800000 + 0x40) )) |= ((0x01<< 7));} while(0); 			
}

__inline void spi_int_disable(void)
{
	do{(*((volatile unsigned long *) (0x00800000 + 0x40) )) &= ~((0x01<< 7));} while(0);			 
}

__inline void spi_txint_disable(void)
{
	(*((volatile unsigned long *) (0x00F00200 + 0x00) )) &= ~(0x01<<6);
}

__inline void spi_txint_enable(void)
{
	(*((volatile unsigned long *) (0x00F00200 + 0x00) )) |= (0x01<<6);
}

__inline void spi_clk_open(void)
{
	(*((volatile unsigned long *) (0x00800000 + 0x14) )) = 0x0;
}

__inline void spi_clk_close(void)
{
	(*((volatile unsigned long *) (0x00800000 + 0x14) )) = 0x01;
}

__inline unsigned long spi_rx_fifo_empty(void)
{
	return ((*((volatile unsigned long *) (0x00F00200 + 0x04) )) & (1<<2));
}

__inline unsigned long spi_tx_fifo_empty(void)
{
	return ((*((volatile unsigned long *) (0x00F00200 + 0x04) )) & (1<<0));
}

void GPIO_SPI_function_enable(void)
{
    GPIO_config((0x05>>4)&0x0F,0x05&0x0F,2);
    GPIO_config((0x06>>4)&0x0F,0x06&0x0F,2);
    GPIO_config((0x04>>4)&0x0F,0x04&0x0F,2);
    GPIO_config((0x07>>4)&0x0F,0x07&0x0F,2);
}
...
void spi_init(SPI_MASTER_SLAVE spi_master_slave)
{
    ...
    if (spi_master_slave == SPI_MASTER)
    {
        ...
        (*((volatile unsigned long *) (0x00F00200 + 0x00) )) = (0x01UL           << 23)
                          | (spi_master_slave << 22)
                          | (0x01UL           << 21)
                          | (0x00UL           << 20)
                          | (0x00UL           << 18)
...
void spi_set_txint_mode(unsigned char mode)
{
    (*((volatile unsigned long *) (0x00F00200 + 0x00) )) &= ~(0x03<<0);
    (*((volatile unsigned long *) (0x00F00200 + 0x00) )) |= (mode<<0);
}
...
void spi_set_rxint_mode(unsigned char mode)
{
    (*((volatile unsigned long *) (0x00F00200 + 0x00) )) &= ~(0x03<<2);
    (*((volatile unsigned long *) (0x00F00200 + 0x00) )) |= (mode<<2);
}
...
void SPI_InterruptHandler(void)
{
    ...
    unsigned char           i;
    unsigned long           txint_mode = ((*((volatile unsigned long *) (0x00F00200 + 0x00) ))>>0)&0x03;
    unsigned long           rxint_mode = ((*((volatile unsigned long *) (0x00F00200 + 0x00) ))>>2)&0x03;
    unsigned long           nss_mode = ((*((volatile unsigned long *) (0x00F00200 + 0x00) ))>>16)&0x03;

    txint = (*((volatile unsigned long *) (0x00F00200 + 0x04) )) & 0x0100;
    rxint = (*((volatile unsigned long *) (0x00F00200 + 0x04) )) & 0x0200;
    ...
    if (txint)
    {
        ...
        for (i=0; i < fifo_empty_num; i++)
        {
            ...
            (*((volatile unsigned long *) (0x00F00200 + 0x08) )) = *p_spi_txdata;
            p_spi_txdata ++;
            spi_transmit_len --;
        ...
        while((*((volatile unsigned long *) (0x00F00200 + 0x00) ))&(0x01 << 16)) 
        {
            spi_trans_start();
        }
    ...
    if (rxint)
    {
        ...
        {
            *p_spi_rxdata = (*((volatile unsigned long *) (0x00F00200 + 0x08) ));
		...
		(*((volatile unsigned long *) (0x00F00200 + 0x04) )) |= 0x0200; 
    }
}
...
{
    if ((*((volatile unsigned long *) (0x00F00200 + 0x04) )) & (0x01<<15))
    {
        return 1;
    }
...
{
    do{ if(!(len<=127)) { bprintf("ASSERT!SPI,%d",290); while(1); } }while(0);
    do{ if(!(tx_data!=0)) { bprintf("ASSERT!SPI,%d",291); while(1); } }while(0);
    do{ if(!(rx_data!=0)) { bprintf("ASSERT!SPI,%d",292); while(1); } }while(0);
...
#line 305 "src\\Driver\\Driver_spi.c"
...
void BK_SPI_Test_Master_Tx(void)
{
    ...
    SPI_transmit_data((uint8 *)spi_tx_data, (uint8 *)spi_rx_data, 127);
...
{
#line 376 "src\\Driver\\Driver_spi.c"
}

#line 408 "src\\Driver\\Driver_spi.c"
