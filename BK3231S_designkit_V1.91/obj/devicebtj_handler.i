...
void send_HCI_command(const unsigned char *buffer,unsigned char data_len)
{
    ...
    u_int8 i;
#line 92 "src\\App\\DeviceBtj_Handler.c"
    for (i = 0; i < data_len; i++)
    {
        TRAhcit_UART_Rx_Char(buffer[i]);
    }
#line 109 "src\\App\\DeviceBtj_Handler.c"
}
...
#line 247 "src\\App\\DeviceBtj_Handler.c"
...
void disconnect_ind(uint8 reason )
{
    ...
    Timer_Start(0,10000);
#line 309 "src\\App\\DeviceBtj_Handler.c"
	sys_flag &= 0X00020000;
    sys_flag|=0X00000020;
...
#line 497 "src\\App\\DeviceBtj_Handler.c"
		...
		else
		{
			for(i = 0; i < num; i++)
			{
		        ...
		        {
#line 538 "src\\App\\DeviceBtj_Handler.c"
		        	writeLinkNum(i);
		            comm_table[0]=0x01;
		            comm_table[1]=0x0b;
		            comm_table[2]=0x04;
...
#line 603 "src\\App\\DeviceBtj_Handler.c"
		flash_set_line_mode(1);
		flash_read_data(linkkey_buff, 0x41000, 32);
        num = linkkey_buff[0];
		flash_set_line_mode(4);
...
#line 717 "src\\App\\DeviceBtj_Handler.c"
    ...
    case DEVICEBTJ_EVENT_PIN_CODE_REQUEST:
        ...
        if(config->work_mode==0x00)
        {
#line 748 "src\\App\\DeviceBtj_Handler.c"
            delay_ms(5);
...
{
	BTBOOL result = (0x01);
#line 807 "src\\App\\DeviceBtj_Handler.c"
    
	if(buffer[0x00]==0x02)
	{
		if(adapter->acl_packets_num > 0x00)
		{
#line 826 "src\\App\\DeviceBtj_Handler.c"
            {            
	...
	{
#line 860 "src\\App\\DeviceBtj_Handler.c"
		while (length > 0x00)
		{
			TRAhcit_UART_Rx_Char(*buffer);
			buffer++;
...
#line 1077 "src\\App\\DeviceBtj_Handler.c"
				}
			}
			else
			{
    ...
    if(sys_flag&0X00000400)
    {
        if((uart_send_cnt || spi_send_cnt) && (sys_flag & 0X00400000))
        {
        	if(uart_send_cnt)
			{
        ...
        else if(uart_send_cnt || spi_send_cnt)
        {
...
#line 1353 "src\\App\\DeviceBtj_Handler.c"
					memcpy(&baudbuf, pbuf + 4, uart_send_length);
				
#line 1366 "src\\App\\DeviceBtj_Handler.c"
...
#line 1478 "src\\App\\DeviceBtj_Handler.c"
	}
	else if(*pbuf == 'C')
	{
	...
	else if(*pbuf == 'N')
	{
		if(uart_send_length >= 4)
		{
			...
			{
#line 1516 "src\\App\\DeviceBtj_Handler.c"
...
#line 1538 "src\\App\\DeviceBtj_Handler.c"
		}
	}
	else if(*pbuf == 'P')
	{
		if(uart_send_length >= 3)
		{
			...
			if(uart_send_length > 0)
			{
#line 1563 "src\\App\\DeviceBtj_Handler.c"
