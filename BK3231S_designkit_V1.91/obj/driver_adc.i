#line 1 "src\\Driver\\driver_adc.c"
...
#line 10 "src\\Driver\\driver_adc.c"
...
#line 11 "src\\Driver\\driver_adc.c"
...
void ADC_Init(uint8 adc_channel)
{
	...
	(*((volatile unsigned long *) (0x00800000 + 0x08) ))   =  0x00; 
  
    adc_config_value  = 0x0 ; 
    adc_config_value |= (0x01 << 0 ) ; 
    adc_config_value |= (adc_channel << 3    ) ; 
    adc_config_value |= (0 << 8 ) ; 
    adc_config_value |= (0 << 10) ; 
    adc_config_value |= (1 << 11 ) ; 
    adc_config_value |= (1 << 16   ) ;
    (*((volatile unsigned long *) (0x00F00700 + 0x00))) = adc_config_value ;
    (*((volatile unsigned long *) (0x00F00500 + 0x18) )) &= ~(1<<adc_channel);
    (*((volatile unsigned long *) (0x00F00500 + 0x18) )) |= (1<<(adc_channel+8));
    (*((volatile unsigned long *) (0x00800000 + 0x40) ))  |=  ((0x01<< 6)|(0x01<<22));
...
void ADC_Deinit(uint8 adc_channel)
{
	...
	(*((volatile unsigned long *) (0x00F00700 + 0x00))) &= ~(0x1 << 2 );

	(*((volatile unsigned long *) (0x00800000 + 0x08) ))   =  0x01; 
    (*((volatile unsigned long *) (0x00F00500 + 0x18) )) |= ((0x1<<adc_channel));
...
{
	uint32	 adc_config_value ;
	adc_config_value = (*((volatile unsigned long *) (0x00F00700 + 0x00))) & (~(0x7<<3));
	adc_config_value |= (chn << 3 ) ;
	(*((volatile unsigned long *) (0x00F00700 + 0x00))) = adc_config_value;
}
...
uint8 ADC_Get_Value(void)
{
    ...
    adc_cnt=0;
    sys_flag &= ~0X00080000;
	(*((volatile unsigned long *) (0x00F00700 + 0x00))) |= (0x1 << 2 )+(0x01 << 0 );
    
	while (!(sys_flag&0X00080000))
    {        
        adc_cnt++;
        if(adc_cnt>150)
        {
    ...
    temp_adc_data=((*((volatile unsigned long *) (0x00F00700 + 0x04)))>>2);
