#line 1 "src\\Driver\\driver_icu.c"
...
#line 2 "src\\Driver\\driver_icu.c"
...
#line 3 "src\\Driver\\driver_icu.c"



void Enable_ICU_Intr(void)
{    
    (*((volatile unsigned long *) (0x00800000 + 0x40) ))|=(    

        (0x01<< 0)|
        (0x01<<16)
    );
    (*((volatile unsigned long *) (0x00800000 + 0x44) ))=(0x01<<0)|(0x01<<1);   
}
void ceva_initial(void)
{
    (*((volatile unsigned long *) (0x00800000 + 0x18) )) = 0x00000000 ;  
    (*((volatile unsigned long *) (0x00800000 + 0x40) ))   = ((0x01<< 0)<<16) + (0x01<< 0);
    (*((volatile unsigned long *) (0x00800000 + 0x7C) )) |=  (0x01<< 0);	
...
void CLK32K_AutoCali_Enable(uint16  sleep_time)
{
    ...
    (*((volatile unsigned long *) (0x00800000 + 0x6C) ))  = sleep_time ; 

    
    rdata = (*((volatile unsigned long *) (0x00800000 + 0x68) )) ; 
    rdata &= (0x1 << 2 )  ;  
    rdata |= (0x1 << 1);  
    rdata |= (0x1 << 0 ) ;  
    (*((volatile unsigned long *) (0x00800000 + 0x68) )) = rdata ; 
}
...
uint8 system_reset_reson(void)
{
    if((*((volatile unsigned long *) (0x00800000 + 0x74) )) & 0x1)
    {
    ...
    else 
    {
        ...
        (*((volatile unsigned long *) (0x00800000 + 0x74) ))=0x1;
...
void  Close_Baseband_Clock(void)
{
    (*((volatile unsigned long *) (0x00800000 + 0x18) ))=0x01; 
}
...
{
    (*((volatile unsigned long *) (0x00800000 + 0x5c) ))  = 0x00;

    (*((volatile unsigned long *) (0x00800000 + 0x50) )) &=  ~(0x1<<18);
    
    (*((volatile unsigned long *) (0x00800000 + 0x50) )) &=  ~(0x1<<21);
    (*((volatile unsigned long *) (0x00800000 + 0x04) ))  = 0;
    (*((volatile unsigned long *) (0x00800000 + 0x5c) )) = (0x01 << 2) + (0x01 << 3 ) + (0x01 << 4 );
    (*((volatile unsigned long *) (0x00800000 + 0x00) )) = 0x0;
...
void Set_CPU_Speed_16M(void)
{
    ...
    (*((volatile unsigned long *) (0x00800000 + 0x00) )) = 0x1;
    (*((volatile unsigned long *) (0x00800000 + 0x04) ))  = 0x00;
    
	
	delay_us(1);
	
	(*((volatile unsigned long *) (0x00800000 + 0x54) )) |= ((0x1<<18) + (0x1<<21));
...
void Set_CPU_PLL_clk(uint8 clk_div)
{
    ...
    SYSirq_Disable_Interrupts_Save_Flags(&cpu_flags);
    (*((volatile unsigned long *) (0x00800000 + 0x5c) ))  = 0x00;
	(*((volatile uint32 *)(0x00F10000+0x24))) = XVR_ANALOG_REG_BAK[9]  = 0x19407D80;
	(*((volatile unsigned long *) (0x00800000 + 0x54) )) &=~((0x1<<18) + (0x1<<21));
	delay_us(5);
	(*((volatile uint32 *)(0x00F10000+0x24))) = XVR_ANALOG_REG_BAK[9]  = 0x19407D00;
	delay_us(15);
	(*((volatile unsigned long *) (0x00800000 + 0x04) ))  = (clk_div<<1);
	(*((volatile unsigned long *) (0x00800000 + 0x00) ))   = 0x3 ;
    SYSirq_Interrupts_Restore_Flags(cpu_flags);
...
void ICU_Initial(void)
{
    ...
    (*((volatile unsigned long *) (0x00800000 + 0x98) ))       = 0x0 ;
	(*((volatile unsigned long *) (0x00800000 + 0x40) )) = 0x00;
    (*((volatile unsigned long *) (0x00800000 + 0x5c) ))  = 0x00;
    (*((volatile unsigned long *) (0x00800000 + 0x80) )) 	 = 0x1 ;
    (*((volatile unsigned long *) (0x00800000 + 0x70) ))=0x500;
    

    (*((volatile unsigned long *) (0x00800000 + 0x24) )) =0X00;



    (*((volatile unsigned long *) (0x00800000 + 0x18) ))=0x00;
    (*((volatile unsigned long *) (0x00800000 + 0x7C) ))=0X05;
	 (*((volatile uint32 *)(0x00F10000+0x24))) = XVR_ANALOG_REG_BAK[9]  = 0x19407D80;
