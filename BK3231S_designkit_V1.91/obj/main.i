...
#line 3 "src\\App\\main.c"
#line 1 ".\\src\\Core\\bt\\include\\bt_init.h"
...
{
    (*((volatile uint32 *)(0x00F10000+0x90))) &= ~(0x7F<<0) ;
    (*((volatile uint32 *)(0x00F10000+0x90))) |= channel    ;
    (*((volatile uint32 *)(0x00F10000+0x94))) &= 0xFFF00000 ;  
    delay_ms(2);
    (*((volatile uint32 *)(0x00F10000+0x94))) |= (0x1<<13) + (0x1<<12) ;
    while(1);   
}
...
#line 95 "src\\App\\main.c"
	
    if(env_config->config_flag&0X20)
        enter_single_carry(0x05);
      
    SYSconfig_Initialise();  
    TRAhcit_Set_Register_Function(TRAhcit_Register_UART_Driver);
    BT_Initialise();
    (*((volatile unsigned long *) (0x00800000 + 0x48) )) = 0xffffffff;
...
int __attribute__((section("fastcall"))) main(void)
{
    ENV_CONFIG_P env_config=(ENV_CONFIG_P)env_config_buff;
    ...
    if(!(env_config->config_flag&0X40))
        SYS_Host_Initialise();
    else
    {
