#line 1 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
#line 29 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 30 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
#line 31 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 1 ".\\src\\Core\\hw\\include\\hw_hab_defs.h"
...
#line 408 ".\\src\\Core\\hw\\include\\hw_hab_defs.h"


#line 32 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 1 ".\\src\\Core\\hw\\include\\hw_habanero.h"
...
#line 23 ".\\src\\Core\\hw\\include\\hw_habanero.h"
#line 24 ".\\src\\Core\\hw\\include\\hw_habanero.h"
#line 25 ".\\src\\Core\\hw\\include\\hw_habanero.h"
...
#line 1 ".\\src\\Core\\lc\\lslc\\include\\lslc_access.h"
#line 196 ".\\src\\Core\\lc\\lslc\\include\\lslc_access.h"
...
#line 26 ".\\src\\Core\\hw\\include\\hw_habanero.h"
...
__inline void HWhab_Set_Syncword_Ref(const u_int32* syncword);
__inline void HWhab_Set_Sync_Error(const u_int8 sync_error);
__inline void HWhab_Set_Rx_Mode(const t_HWradio_Rx_Mode rx_mode);
__inline void HWhab_Set_DADC_Bypass(const boolean state);
__inline void HWhab_Set_RADC_Bypass(const boolean state);
__inline void HWhab_Set_RADC_Num(const boolean state);
__inline void HWhab_Set_FDB_DIS(const boolean state);
__inline void HWhab_Set_Sym_Gn(const u_int8 gain);
__inline void HWhab_Set_Sym_Enb(const boolean state);
__inline void HWhab_Set_Sym_Mask(const boolean state);
__inline void HWhab_Set_Cmb_C1(const u_int8 c1);
__inline void HWhab_Set_Cmb_C2(const u_int8 c2);
__inline void HWhab_Set_OCL_DC_Offset(const u_int8 offset);
__inline void HWhab_Set_OCL_Feedback_Mode(const boolean state);
__inline void HWhab_Set_OCL_Low_Gain(const u_int8 low_gain);
__inline void HWhab_Set_OCL_High_Gain(const u_int8 high_gain);

__inline void HWhab_Get_Syncword_Ex(u_int32 *);
__inline u_int8 HWhab_Get_Sync_Error(void);
__inline t_HWradio_Rx_Mode HWhab_Get_Rx_Mode(void);
__inline boolean HWhab_Get_DADC_Bypass(void);
__inline boolean HWhab_Get_RADC_Bypass(void);
__inline boolean HWhab_Get_RADC_Num(void);
__inline boolean HWhab_Get_FDB_DIS(void);
__inline u_int8 HWhab_Get_Sym_Gn(void);
__inline boolean HWhab_Get_Sym_Enb(void);
__inline boolean HWhab_Get_Sym_Mask(void);
__inline u_int8 HWhab_Get_Cmb_C1(void);
__inline u_int8 HWhab_Get_Cmb_C2(void);
__inline u_int8 HWhab_Get_OCL_DC_Offset(void);
__inline boolean HWhab_Get_OCL_Feedback_Mode(void);
__inline u_int8 HWhab_Get_OCL_Low_Gain(void);
__inline u_int8 HWhab_Get_OCL_High_Gain(void);



 
__inline void HWhab_Set_Gaussian_Coeff(const u_int8 index, const u_int8 value);
__inline void HWhab_Set_DAC_Bypass(const boolean state);
__inline void HWhab_Set_DAC_Ref(const u_int8 voltage_ref);
__inline void HWhab_Set_Gaussian_Offset(const u_int16 value);  

__inline u_int8 HWhab_Get_Gaussian_Coeff(const u_int8 index);
__inline boolean HWhab_Get_DAC_Bypass(void);
__inline u_int8 HWhab_Get_DAC_Ref(void);
__inline u_int16 HWhab_Get_Gaussian_Offset(void);



 
__inline void HWhab_Set_RIF_Intr_Mask0(const boolean state);
__inline void HWhab_Set_RIF_Intr_Mask1(const boolean state);
__inline void HWhab_Set_RIF_Intr_Mask2(const boolean state);
__inline void HWhab_Set_RIF_Intr_Mask3(const boolean state);
__inline void HWhab_Set_LTR_Intr_Mask(const boolean state);

__inline void HWhab_Set_RIF_Intr_Clr(const u_int8 clear_value);
__inline void HWhab_Set_LTR_Intr_Clr(const u_int8 value);

__inline boolean HWhab_Get_RIF_Intr_Mask0(void);
__inline boolean HWhab_Get_RIF_Intr_Mask1(void);
__inline boolean HWhab_Get_RIF_Intr_Mask2(void);
__inline boolean HWhab_Get_RIF_Intr_Mask3(void);
__inline boolean HWhab_Get_LTR_Intr_Mask(void);

__inline u_int8 HWhab_Get_RIF_Intr_Clr(void);
__inline u_int8 HWhab_Get_LTR_Intr_Clr(void);



 
__inline void HWhab_Set_PHY_Cfg(const u_int32 magic_phy_value);

__inline u_int32 HWhab_Get_PHY_Cfg(void);



 
__inline u_int8 HWhab_Get_RADC_RSSI(void);        
__inline u_int8 HWhab_Get_LTR_Long_Period(void);  
__inline u_int8 HWhab_Get_LTR_Intr(void);         
__inline u_int8 HWhab_Get_RIF_Intr(void);         
__inline u_int8 HWhab_Get_GIO_Status(void);
__inline u_int8 HWhab_Get_Core_Minor_Rev(void);   
__inline u_int8 HWhab_Get_Core_Major_Rev(void);   



 
__inline u_int8 HWhab_Set_GIO_Ctrl(const u_int8 index, const u_int8 value);



 
__inline void HWhab_Set_Rst_Code(const u_int8 code);

__inline u_int8 HWhab_Get_Rst_Code(void);

#line 1 ".\\src\\Core\\hw\\include\\hw_habanero_impl.h"
...
#line 23 ".\\src\\Core\\hw\\include\\hw_habanero_impl.h"

#line 456 ".\\src\\Core\\hw\\include\\hw_habanero_impl.h"
...
#line 159 ".\\src\\Core\\hw\\include\\hw_habanero.h"


#line 33 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 34 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 35 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 36 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
#line 37 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 1 "src\\hal\\hw\\radio\\bk3011\\./include/hw_radio_defs.h"
...
#line 26 "src\\hal\\hw\\radio\\bk3011\\./include/hw_radio_defs.h"
#line 27 "src\\hal\\hw\\radio\\bk3011\\./include/hw_radio_defs.h"
...
#line 106 "src\\hal\\hw\\radio\\bk3011\\./include/hw_radio_defs.h"
...
#line 183 "src\\hal\\hw\\radio\\bk3011\\./include/hw_radio_defs.h"


#line 38 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi.h"
...
__inline void SYSmmi_Display_eSYSmmi_TX_START_Event(void);
__inline void SYSmmi_Display_eSYSmmi_BTCLK_Tick_Event(void);
__inline void SYSmmi_Display_eSYSmmi_TX_MID_Event(void);
__inline void SYSmmi_Display_eSYSmmi_RX_START_Event(void);
__inline void SYSmmi_Display_eSYSmmi_RX_MID_Event(void);
__inline void SYSmmi_Display_eSYSmmi_PKA_Event(void);
__inline void SYSmmi_Display_eSYSmmi_SYNC_DET_Event(void);
__inline void SYSmmi_Display_eSYSmmi_NO_PKT_RCVD_Event(void);
__inline void SYSmmi_Display_eSYSmmi_PKT_RX_HDR_Event(void);
__inline void SYSmmi_Display_eSYSmmi_PKD_Event(void);
__inline void SYSmmi_Display_eSYSmmi_HCIt_Activity_Event(void);
__inline void SYSmmi_Display_eSYSmmi_LC_Connection_Event(void);
__inline void SYSmmi_Display_eSYSmmi_LM_Connection_Event(void);
__inline void SYSmmi_Display_eSYSmmi_LC_Disconnection_Event(void);
__inline void SYSmmi_Display_eSYSmmi_LM_Disconnection_Event(void);
__inline void SYSmmi_Display_eSYSmmi_Scan_Active_Event(void);
__inline void SYSmmi_Display_eSYSmmi_Scan_Inactive_Event(void);

#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi_impl.h"
...
#line 25 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi_impl.h"
#line 26 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi_impl.h"

#line 1 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi.h"
#line 28 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi_impl.h"
...
#line 67 ".\\src\\hal\\prth_chimera\\sys\\include\\sys_mmi.h"


#line 39 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 40 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 41 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
#line 42 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
#line 63 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
static u_int8 power_level_now = 2;  

u_int32 rawRSSIvalue=0x00;  
...
#line 133 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
#line 213 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"



void __attribute__((section("fastcall"))) BK3000_Write_RF_CH(u_int8 channel_nb)
{
    u_int32 v;


    v=(*((volatile uint32 *)(0x00F10000+0x90)));
    ...
    (*((volatile uint32 *)(0x00F10000+0x90)))=v;
...
#line 249 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"

void Send_Receive_Command_Now(u_int8 channel_nb) 
{
    BK3000_Write_RF_CH(channel_nb);    

#line 270 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
void __attribute__((section("fastcall"))) TIM0_TX_START_Radio_Process()
{
...
#line 302 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"

  }
}

void __attribute__((section("fastcall"))) TIM1_TX_Middle_Radio_Process()
{
...
#line 327 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"

  }
}

void __attribute__((section("fastcall"))) TIM2_RX_START_Radio_Process()
{
    if(RADIO_MODE_MASTER_DOUBLE_WIN==CurrentRadioMode)
    {
        BK3000_Write_RF_CH(rf_channels_save[RX_MID]);

#line 352 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"

  }
}

void __attribute__((section("fastcall"))) TIM3_RX_Middle_Radio_Process()
{
  if( (RADIO_MODE_SLAVE_PAGE_RESP==CurrentRadioMode)||(RADIO_MODE_MASTER_DOUBLE_WIN==CurrentRadioMode)||(RADIO_MODE_TX_RX==CurrentRadioMode))     
  {
    BK3000_Write_RF_CH(rf_channels_save[TX_START]);

#line 376 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
__inline void  SetRFSyncWindow(u_int8 win_size)
{
    u_int32 v;
...
#line 602 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
...
void __attribute__((section("fastcall"))) HWradio_SetRadioMode(t_RadioMode in_RadioMode)
{
    ...
    {
        HWradio_Service(Requested_RadioMode, 0, 0);
    }
}
...
t_RadioMode __attribute__((section("fastcall"))) HWradio_GetRadioMode()
{
...
static boolean __attribute__((section("fastcall"))) HWradio_Service(t_RadioMode in_RadioMode, t_freq *io_Channels, t_radio_freq_mask freq_mask)
{
    boolean lv_result =  (!0);

#line 1247 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
        ...
        case RADIO_MODE_FULL_RX :
            ...
            switch(CurrentRadioMode)
            {
                ...
                case RADIO_MODE_TX_RX:
                        ...
                        if(((freq_mask & ((t_radio_freq_mask)(1 << (RX_START)))) != 0))
                        {
        ...
        case RADIO_MODE_SLAVE_PAGE_RESP:            
            ...
            switch(CurrentRadioMode)
            {
                ...
                case RADIO_MODE_SLAVE_PAGE_RESP:
                    ...
                    if (((freq_mask & ((t_radio_freq_mask)(1 << (TX_START)))) != 0))
                    {
        ...
        case RADIO_MODE_MASTER_DOUBLE_WIN :
            ...
            {        
                ...
                case RADIO_MODE_MASTER_DOUBLE_WIN :
                        ...
                        if (((freq_mask & ((t_radio_freq_mask)(1 << (TX_MID)))) != 0))
                        {
                        ...
                        if (((freq_mask & ((t_radio_freq_mask)(1 << (RX_MID)))) != 0))
                        {
...
void __attribute__((section("fastcall"))) WRITE_BK3000_TX_POWER(u_int8 power_level)
{
    u_int32 regv_0x24;
    ...
    regv_0x24=(*((volatile uint32 *)(0x00F10000+0x90)))&0xFFFFF87F;        
    ...
    (*((volatile uint32 *)(0x00F10000+0x90)))=regv_0x24;
...
void HWradio_Set_Rx_Gain(u_int32 x)
{
#line 1659 "src\\hal\\hw\\radio\\bk3011\\hw_radio.c"
}
...
boolean __attribute__((section("fastcall"))) HWradio_Update_Internal_RSSI_Cache(boolean late_read_opportunity)
{
    if (((( ( 0x0102 &0xFF & ( (0xFF*(1==0) & 0x07) | (0xFF*(1==1) & 0x07) | (0xFF*(1==2) & 0x07) | (0xFF*(1==3) & 0x07) | (0xFF*(1==4) & 0x07) | (0xFF*(1==5) & 0x07)) ) != 0 )==1) &&
         (CurrentRadioMode == RADIO_MODE_TX_RX)) ||
        ((( ( 0x0340 &0xFF & ( (0xFF*(1==0) & 0x40) | (0xFF*(1==1) & 0x7e) | (0xFF*(1==2) & 0xFE) | (0xFF*(1==3) & 0xFE) | (0xFF*(1==4) & 0xFE) | (0xFF*(1==5) & 0xFA)) ) != 0 )==1) &&
         (CurrentRadioMode == RADIO_MODE_MASTER_DOUBLE_WIN)))
    {
        if( (!late_read_opportunity) && (1!=2))
        {
