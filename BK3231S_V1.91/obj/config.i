...
void Initial_config(void)
{
    ...
    g_beken_initial_config.g_lm_config_sleep_in_standby_monitor_period=0x7ff; 
    g_beken_initial_config.g_lm_config_awake_in_standby_monitor_period=0x04e;
    g_beken_initial_config.g_lm_config_awake_keep_when_UART_Wakeup_period=0x3fff; 
