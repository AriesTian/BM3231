#line 1 "src\\Driver\\driver_timer.c"
...
#line 10 "src\\Driver\\driver_timer.c"
...
#line 11 "src\\Driver\\driver_timer.c"
...
{
	uint32 intr_v;
	intr_v = (*((volatile unsigned long *) (0x00800000 + 0x3C) ));
	intr_v &= ~(0x03<<8);	
	...
	(*((volatile unsigned long *) (0x00800000 + 0x3C) )) = intr_v;
	(*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) )) = 0;
    (*((volatile unsigned long *) (0x00800000 + 0x40) ))  |=  ((0x01<<12)|(0x01<<28));
...
void Timer_Start(uint8 index,uint32 cnt)
{
	...
	{
		case 0:
			(*( (volatile unsigned long *) (0x00F00A00 + (0x2*4)) )) = (count&0xffff);
			bk_timer_T0_cnt = (count&0xffff);
			(*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) )) |=( 0x00000001 | 0x00000002);
			break;
		case 1:
			(*( (volatile unsigned long *) (0x00F00A00 + (0x4*4)) )) = (count&0xffff);
			bk_timer_T1_cnt = (count&0xffff);
			(*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) )) |= (0x00000004 | 0x00000008);
			break;
		default:
			break;
	}
...
void HW_set_aux_sys_timer(uint32 cnt)
{
    ...
    (*( (volatile unsigned long *) (0x00F00A00 + (0x6*4)) )) = (count&0xffff);
    (*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) )) |= (0x00000010 | 0x00000020);
}
...
void Timer_Stop(uint8 index)
{
    ...
    if(index==0)
    {
        intr_v = (*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) ));
        intr_v &= ~0x00000001;
        intr_v &= ~0x00000002;
        (*( (volatile unsigned long *) (0x00F00A00 + (0x0*4)) )) = intr_v;
        bk_timer_hit &= ~0x01;
...
void Timer_ISR0(uint8 sck)
{
	...
	tmpdata = (*( (volatile unsigned long *) (0x00F00A00 + (0x3*4)) ));
	if((( tmpdata - dT0Tmp)>4) || (sck))
	{
		bk_timer_hit |= 0x01;
		(*( (volatile unsigned long *) (0x00F00A00 + (0x2*4)) )) = bk_timer_T0_cnt;
	}
	dT0Tmp = tmpdata;
}
...
{
	uint32 tmpdata;
	tmpdata = (*( (volatile unsigned long *) (0x00F00A00 + (0x5*4)) ));
...
{
	uint32 tmpdata;
	tmpdata = (*( (volatile unsigned long *) (0x00F00A00 + (0x7*4)) ));
...
{
	uint32 intr_v;
	intr_v = (*( (volatile unsigned long *) (0x00F00A00 + (0x1*4)) ));
    
	if(intr_v & 0x00000001)
    {   
	...
	(*( (volatile unsigned long *) (0x00F00A00 + (0x1*4)) )) = intr_v;
}
