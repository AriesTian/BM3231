#line 1 "src\\App\\DeviceBtj_Handler.c"
...
#line 31 "src\\App\\DeviceBtj_Handler.c"
#line 1 ".\\src\\Core\\btj_src\\include\\command_table.h"
...
#line 18 ".\\src\\Core\\btj_src\\include\\command_table.h"
...
{0x01, 0x0f, 0x04, 0x04, 0x32, 0x00, 0x06, 0x33}; 

const unsigned char Com_Table_Read_Feature[] = 
{0x01,0x03, 0x10, 0x00};

#line 32 "src\\App\\DeviceBtj_Handler.c"
...
#line 33 "src\\App\\DeviceBtj_Handler.c"
#line 34 "src\\App\\DeviceBtj_Handler.c"
#line 35 "src\\App\\DeviceBtj_Handler.c"
...
#line 36 "src\\App\\DeviceBtj_Handler.c"
#line 1 ".\\src\\Core\\bt\\include\\bt_test.h"
...
#line 19 ".\\src\\Core\\bt\\include\\bt_test.h"
...
typedef enum
{
       ...
       DUT_ENABLED             = 1,      
       DUT_ACTIVE              = 2,      
       DUT_ACTIVE_LOOPBACK     = 3,      
       DUT_ACTIVE_TXTEST       = 4,      
       DUT_STANDALONE_TXTEST   = 5,      
       DUT_STANDALONE_RXTEST   = 6,      
       DUT_TESTMODE_TESTER     = 7       
} t_dut_mode;
...
typedef struct
{
    ...
    t_connectionHandle connection_handle[1+1];
} t_loopback_info;


__inline void BTtst_Initialise(void);

t_error BTtst_Write_Loopback_Mode(t_loopback_mode loop_back_mode);
__inline t_loopback_mode BTtst_Read_Loopback_Mode(void);

__inline t_dut_mode BTtst_Get_DUT_Mode(void);
__inline void BTtst_Set_DUT_Mode(t_dut_mode new_dut_mode);
...
#line 1 ".\\src\\Core\\bt\\include\\bt_test_impl.h"
...
#line 20 ".\\src\\Core\\bt\\include\\bt_test_impl.h"
...
#line 21 ".\\src\\Core\\bt\\include\\bt_test_impl.h"

#line 29 ".\\src\\Core\\bt\\include\\bt_test_impl.h"
...
#line 81 ".\\src\\Core\\bt\\include\\bt_test.h"


#line 37 "src\\App\\DeviceBtj_Handler.c"
#line 38 "src\\App\\DeviceBtj_Handler.c"
...
u_int8 bt_tx_buff[10];
u_int8 at_uart_send_length = 0;


u_int8 ios_key_buff[6]  = {0xa1, 0x03, 0x00, 0x00, 0x00, 0x20};
...
void send_HCI_command(const unsigned char *buffer,unsigned char data_len)
{
    ...
    u_int8 i;
#line 100 "src\\App\\DeviceBtj_Handler.c"
    for (i = 0; i < data_len; i++)
    {
        TRAhcit_UART_Rx_Char(buffer[i]);
    }
#line 117 "src\\App\\DeviceBtj_Handler.c"
}
...
{	
	...
	else if(config->work_mode==0x01)
	{
		...
		spp_service.rfc_context.rfc_mtu            = (0x0080);
...
#line 255 "src\\App\\DeviceBtj_Handler.c"
...
void connect_ind()
{
    ...
    if(sys_flag &0X00000020)
    {
        DeviceHci_Disconnect(&btj_adapter, btj_adapter.hci_context->hci_context_handle, (0x15));        
        return;
    }
...
#line 322 "src\\App\\DeviceBtj_Handler.c"
	sys_flag &= 0X00020000;
    sys_flag|=0X00000020;
...
void DeviceBtj_linkkey_save(BTBYTE *linkkey)
{
    ...
    if((sys_flag & 0X00100000) && (!(sys_flag & 0X00040000)))
    {
        ...
        if(sys_flag & 0X00000004)
            linkkey_buff_temp[22]=0X00000004;
        else
...
{          
    ...
    if((sys_flag&0X00000400) && !(sys_flag&(0X00002000|0X00000001)))
    {
        time_cnt++;          
    }
    else
    ...
    if( (time_cnt>=1000) && (sys_flag&0X00000080))
    {
        time_cnt=0;
        sys_flag &= (~0X00000080);
    ...
    if(config->work_mode==0x01)
        return;
	if(( sys_flag&0X00000040)&&(!(sys_flag&0X00001000)) )
	{
		time_cnt=0;
		if(!(sys_flag&0X00002000))
		{
			sys_flag |= 0X00002000;           
			enter_sniff();
		}
	}
    if( (sys_flag&0X00000100) && !(sys_flag&0X00000200))
    {
        sys_flag &= ~0X00000100;
        flash_set_line_mode(1);   
...
#line 518 "src\\App\\DeviceBtj_Handler.c"
		...
		else
		{
			for(i = 0; i < num; i++)
			{
		        ...
		        {
#line 559 "src\\App\\DeviceBtj_Handler.c"
		        	writeLinkNum(i);
		            comm_table[0]=0x01;
		            comm_table[1]=0x0b;
		            comm_table[2]=0x04;
		            ...
		            if( linkkey_buff[22]==(0X00000004&0xff) )     
		                sys_flag |= 0X00000004;
					break;
		        }
		        else
...
#line 625 "src\\App\\DeviceBtj_Handler.c"
		flash_set_line_mode(1);
		flash_read_data(linkkey_buff, 0x41000, 32);
        num = linkkey_buff[0];
		flash_set_line_mode(4);
...
#line 743 "src\\App\\DeviceBtj_Handler.c"
    ...
    case DEVICEBTJ_EVENT_PIN_CODE_REQUEST:
        ...
        if(config->work_mode==0x00)
        {
#line 776 "src\\App\\DeviceBtj_Handler.c"
            delay_ms(5);
...
{
	BTBOOL result = (0x01);
#line 835 "src\\App\\DeviceBtj_Handler.c"
    
	if(buffer[0x00]==0x02)
	{
		if(adapter->acl_packets_num > 0x00)
		{
#line 854 "src\\App\\DeviceBtj_Handler.c"
            {            
	...
	{
#line 888 "src\\App\\DeviceBtj_Handler.c"
		while (length > 0x00)
		{
			TRAhcit_UART_Rx_Char(*buffer);
			buffer++;
...
)
{
    ...
    else
    {
        ...
        HCI_CONTEXT_P hci_context = (0x00);
         
        for (hci_index = 0x00; hci_index < (0x01) && hci_context == (0x00); hci_index++)
        {
        ...
        if (state != DEVICEBTJ_STATE_FAILURE_INSTANCE)
        {
            if (hci_context == (0x00))
            {
                ...
                Service->sdp_database.busy = (0x01);
            ...
            else
            {
                ...
                DeviceL2c_Send_ConnectionReq(Adapter, Service, hci_context, (0x0001));
...
void __attribute__((section("fastcall"))) Host_Loop()
{
	...
	if(config->work_mode < 3)
    {
        if(uart_send_cnt == 0x00)
        {
            uart_rx_buff_temp = uart_rx_buff_header;
            if (uart_rx_buff_tailor < uart_rx_buff_temp)
            {
                if((uart_rx_buff_temp - uart_rx_buff_tailor) > (100-uart_cnt_index))
                    temp_data_len = 100 - uart_cnt_index;
                else
                ...
                uart_rx_buff_tailor=(uart_rx_buff_tailor%512);
                uart_rx_buff_cnt=0;
                
            }
            else if (uart_rx_buff_tailor > uart_rx_buff_temp)
            {
                if((512 - uart_rx_buff_tailor)>=(100-uart_cnt_index))
                {
                    temp_data_len=100-uart_cnt_index;
                    uart_callback(uart_rx_tx_buff + uart_rx_buff_tailor, temp_data_len);
                    uart_rx_buff_tailor+=temp_data_len;
                ...
                {
                    temp_data_len=512 - uart_rx_buff_tailor;
                    uart_callback(uart_rx_tx_buff + uart_rx_buff_tailor, temp_data_len);
                    uart_rx_buff_tailor+=temp_data_len;
                    uart_rx_buff_tailor=(uart_rx_buff_tailor%512);
                    if((uart_rx_buff_temp - uart_rx_buff_tailor)>=(100-uart_cnt_index))
            ...
            else if((uart_rx_buff_tailor == uart_rx_buff_temp) && (uart_cnt_index > 0)) 
            {
                uart_rx_buff_cnt++;
				
                if(uart_rx_buff_cnt >= 20)
    ...
    {
        if (btj_adapter.uih_credits_l2c != (0x00) && btj_adapter.uih_credits_rfc != (0x00))
        {
            L2C_CONTEXT_P l2c_context = btj_adapter.uih_credits_l2c;
            RFC_CONTEXT_P rfc_context = btj_adapter.uih_credits_rfc;
             
            DeviceRfc_UihHeader(btj_adapter.uih_credits_buf, l2c_context, ((((BTBYTE)0xEF) | 0x10)), ((BTBYTE)(rfc_context->rfc_init ? 0x01 : 0x00)), rfc_context->rfc_sc, (0x05) + 0x01);
             
            btj_adapter.uih_credits_buf[sizeof(HCI_COMMON_T) + (0x04)] = rfc_context->rfc_lcredit;
            ...
            btj_adapter.uih_credits_l2c = (0x00);
            btj_adapter.uih_credits_rfc = (0x00);  
        }
        if(rfcomm_dis_fail)
        {
            rfcomm_dis_fail=0;
    ...
    if(sys_flag&0X00000400)
    {
        ...
        if(uart_send_cnt && (sys_flag & 0X00400000))
        {
        	if(uart_send_cnt)
			{
	            ...
	            {	
					...
					if(AT_flag == 1)
					{
						...
						if(!getATCommand((uint8*)uart_send_buff))
						{
							...
							memcpy(dataBuf, uart_send_buff + 3, at_uart_send_length);
        ...
        else if(uart_send_cnt)
        {
			...
			if(uart_send_length )
			{
	            ...
	            else if((send_cnt == 10) && (hid_flag != 1))
	            {
	            	if((DeviceHid_Send(&btj_adapter, &hid_service, bt_tx_buff, 10)))
					{
						hid_flag = 1;
...
#line 1424 "src\\App\\DeviceBtj_Handler.c"

			 
			Driver_wdt_enable(0x0001);  
...
#line 1462 "src\\App\\DeviceBtj_Handler.c"
...
#line 1512 "src\\App\\DeviceBtj_Handler.c"
...
static void getCommandData(uint8 *pbuf)
{
	...
	if(*pbuf =='A')
	{
		if((!memcmp(pbuf, "ADDR", 4)) || (!memcmp(pbuf, "ADDR\r\n", 6)))
			bprintf("\r\n+ADDR=%02x%02x%02x%02x%02x%02x\r\n\r\nOK\n", config->bt_addr[0], config->bt_addr[1],				 config->bt_addr[2], config->bt_addr[3], config->bt_addr[4], config->bt_addr[5]);
...
#line 1569 "src\\App\\DeviceBtj_Handler.c"
					memcpy(&baudbuf, pbuf + 4, at_uart_send_length);
				
#line 1582 "src\\App\\DeviceBtj_Handler.c"
...
#line 1694 "src\\App\\DeviceBtj_Handler.c"
	}
	else if(*pbuf == 'C')
	{
	...
	else if(*pbuf == 'N')
	{
		if(at_uart_send_length >= 4)
		{
			...
			{
#line 1778 "src\\App\\DeviceBtj_Handler.c"
...
#line 1800 "src\\App\\DeviceBtj_Handler.c"
		}
	}
	else if(*pbuf == 'P')
	{
		if(at_uart_send_length >= 3)
		{
			...
			if(at_uart_send_length > 0)
			{
#line 1825 "src\\App\\DeviceBtj_Handler.c"
