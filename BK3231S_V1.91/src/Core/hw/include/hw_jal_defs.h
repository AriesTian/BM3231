 ...
 *     All rights reserved.
 *
 * SOURCE CONTROL: $Id: hw_jal_defs.h,v 1.88 2011/04/01 16:02:53 garyf Exp $
 *
 * COMMENTS:
 *
...
#define JAL_SYNC_DIR_ADDR  (0x00000028 + JAL_BASE_ADDR)
...
#define BEKEN_xver_soft_reset_ADDR         (0x00000070 + JAL_BASE_ADDR)/* 0x00F76070 */
