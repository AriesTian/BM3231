...
//t_error TCI_Dispatch_Prop_Command_MTK_SPECAIL_OGF_39(u_int8* p_payload, u_int16 opcode);
//t_error TCI_Dispatch_Prop_Command_MTK_SPECAIL_OGF_1f(u_int8* p_payload, u_int16 opcode);
//t_error TCI_Dispatch_Prop_Command_MTK_SPECAIL_OGF_23(u_int8* p_payload, u_int16 opcode);
//#endif
