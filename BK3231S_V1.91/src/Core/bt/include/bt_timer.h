 ...
 *
 * SOURCE CONTROL: $Id: bt_timer.h,v 1.16 2005/05/12 09:27:11 namarad Exp $
 *
 * NOTES TO USERS:
 ...
 */
t_timer FAST_CALL BTtimer_Set_Slots(t_slots timeSlots);
 ...
 ************************************************************************/
t_timer FAST_CALL BTtimer_Piconet_Reset_Delta_Slots(
 ...
 ************************************************************************/
t_timer FAST_CALL BTtimer_Set_Timer_On_Timing_Equation( 
    t_clock ref_time_ticks,             /* -i   Time to check equations at  */
 ...
 ************************************************************************/
boolean FAST_CALL BTtimer_Is_Timing_Equation_Satisfied(                        
    t_clock ref_time_ticks,             /* -i   Time to check equations at  */
 ...
 ************************************************************************/
boolean FAST_CALL BTtimer_Is_Expired_For_Time(
    t_timer timer,                      /* -i   Timer to Adjust             */
    t_clock ref_time_ticks              /* -i   Time to check equations at  */
    );    
