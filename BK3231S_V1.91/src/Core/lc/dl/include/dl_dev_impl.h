 ...
 * DATE:           27 May 1999
 *
 * SOURCE CONTROL: $Id: dl_dev_impl.h,v 1.116 2011/01/19 17:23:46 garyf Exp $
 *
 * LICENSE:
...
#pragma inline(DL_Get_RSSI,\
DL_Update_RSSI_Average)
#endif
...
__INLINE__ void FAST_CALL DL_Set_Clock_Offset(t_devicelink* pDevLink, t_clock clk)
{
...
/*
 * weights 25% of new rssi with 75% of previous average, so weights
 * history as 25%, 18.75%, 14%, 10.5%, 7.9%, 5.9%, 4.4%, 3.3%...
 */
__INLINE__ void DL_Update_RSSI_Average(t_devicelink* p_device_link, s_int8 rssi)
{
    ...
    /* save new rssi average with trunc & trail compensation */
...
#if ((PRH_BS_CFG_SYS_SYN_VIA_HCI_SUPPORTED == 1) && (PRH_BS_CFG_SYS_LMP_ERRONOUS_DATA_REPORTING_SUPPORTED == 1) )
