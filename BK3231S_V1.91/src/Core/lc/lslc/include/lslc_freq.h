 ...
 */
void FAST_CALL LSLCfreq_Prepare_Frequency_Context(const t_devicelink *p_device_link,
 ...
 */
t_clock FAST_CALL LSLCfreq_Get_Last_Frequency_Clock(void);
 ...
 */
void FAST_CALL LSLCfreq_Early_Prepare_TxRxFreqs_SlavePageResponse(void);

/*
 * Prepare the outgoing frequency for the first FHS in master page response
 */
void FAST_CALL LSLCfreq_Prepare_Frequency_FirstFHS_MasterPageResponse(t_clock base_clk);
