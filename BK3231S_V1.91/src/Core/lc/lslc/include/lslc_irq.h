 ...
 *
 * SOURCE CONTROL: $Id: lslc_irq.h,v 1.14 2004/10/05 09:40:29 namarad Exp $
 *
 * LICENSE:
...
void FAST_CALL LSLCirq_IRQ_Handler(void);

void LSLCirq_Disable_All_Intr_Except(u_int32 except_tim_intr_mask);

void FAST_CALL LSLCirq_R2P_Turn_On_Intr(void);
