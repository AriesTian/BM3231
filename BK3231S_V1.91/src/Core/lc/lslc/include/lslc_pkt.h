 ...
 * DATE:           12 Jun 1999
 *
 * SOURCE CONTROL: $Id: lslc_pkt.h,v 1.32 2008/10/09 15:32:59 tomk Exp $
 *
 * LICENSE:
...
void LSLCpkt_Prepare_Receiver_ID(const t_devicelink *pDevLink,
    t_state context);
void LSLCpkt_Prepare_Receiver_FHS(const t_devicelink *pDevLink,
    t_state context);
void LSLCpkt_Prepare_Receiver_Connection(const t_devicelink *pDevLink);

#if (PRH_BS_CFG_SYS_LMP_MSS_SUPPORTED==1)
void LSLCpkt_Prepare_Receiver_Master_Slave_Switch(const t_devicelink *pDevLink);
#endif
...
void LSLCpkt_Generate_ID(t_devicelink *pDevLink, t_state IDcontext);
...
void LSLCpkt_Generate_NULL(t_devicelink *pDevLink);
void LSLCpkt_Generate_POLL(t_devicelink *pDevLink);
void LSLCpkt_Generate_ACL(t_devicelink *pDevLink);
void LSLCpkt_Generate_SCO(t_devicelink *pDevLink);
