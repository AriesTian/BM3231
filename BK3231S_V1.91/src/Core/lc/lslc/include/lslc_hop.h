...
t_freq  FAST_CALL LSLChop_Get_Next_Frequency(t_state state, t_clock clk);
t_freq  FAST_CALL LSLChop_Get_Frequency_Channel_Connection(
...
u_int   FAST_CALL LSLChop_Get_X(void);
void    LSLChop_Freeze_X_for_Page(t_clock clk);
void    FAST_CALL LSLChop_Set_X_for_Inquiry(t_clock clk);
void    LSLChop_Increment_X_Page_Scan(void);
void    LSLChop_Increment_N_Inquiry_Scan(void);

t_rfSelection FAST_CALL LSLChop_Get_rfSelection(void);
void LSLChop_Set_HSE_Engine(t_hse_type hse_type);
t_hse_type FAST_CALL LSLChop_Get_HSE_Engine(void);
...
u_int32 FAST_CALL LSLChop_Execute_79_Hop_Kernel_Connection_Summation(
