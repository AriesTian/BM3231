 ...
 *
 * SOURCE CONTROL: $Id: lc_types.h,v 1.47 2011/04/01 16:03:06 garyf Exp $
 *
 * LICENSE:
...
#if 1//(PRH_BS_CFG_SYS_SCATTERNET_SUPPORTED ==1) // GF 26 Jan - Moved to device Link for Scatternet
