...
void GPIO_Initial(void)  // As GPIO Output
{
	...
	//IOS 键盘出入仓功能
	GPIO_config(0, 2, 0); 	//p02 input and PULLUP

	/* enter single carry test pin, both pins have to low */
	GPIO_config(3, 6, 0);	//p36 input and PULLUP
	//GPIO_config(3, 5, 0); 	//p35 input and PULLUP
	GPIO_config(3, 7, 0); 	//p37 input and PULLUP
